...
class Event(SerifTheory):
    ...
    granular_template_type_attribute_score = _SimpleAttribute(float)
    completion_score = _SimpleAttribute(float)
    over_time_score = _SimpleAttribute(float)
    coordinated_score = _SimpleAttribute(float)
    project_type_score = _SimpleAttribute(float)
