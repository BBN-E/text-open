...
@JsonSerialize(as = ImmutableDependencies.class)
@JsonDeserialize(as = ImmutableDependencies.class)
@TextGroupImmutable
@org.immutables.value.Value.Immutable
@Functional
public abstract class Dependencies implements Iterable<Proposition>, PotentiallyAbsentSerifTheory {
  ...
  protected void check() {
    ...
    if (mentions().isPresent()) {
      ...
      checkArgument(isAbsent(), "Mentions element may only be present for absent Dependencies");
    }
  }

  public static Dependencies absent() {
  ...
  public final int numDependencies() {
  ...
  public static class Builder extends ImmutableDependencies.Builder {
