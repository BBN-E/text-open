...
@TextGroupImmutable
@Value.Immutable
public abstract class PropPatternMatch extends AbstractPatternMatch implements PatternMatch  {
  ...
  public abstract Proposition proposition();

  @Override
  public final Optional<Spanning> spanning() {
    return Optional.<Spanning>of(proposition());
  }
  ...
  public static PropPatternMatch of(Pattern pattern, DocTheory docTheory,
      SentenceTheory sentenceTheory, Proposition proposition) {
    return ImmutablePropPatternMatch.builder()
        .pattern(pattern)
        .docTheory(docTheory)
        .sentenceTheory(sentenceTheory)
        .proposition(proposition).build();
  }
}
