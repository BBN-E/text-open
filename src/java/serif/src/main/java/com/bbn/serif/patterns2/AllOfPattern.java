...
/**
 * A pattern which matches if all of its sub-patterns match on a single extraction unit.
 *
 ...
 * These may have any number of subpatterns.
 *
 * Example:
 * <pre>
 *  (all-of (members (mention (acetype PER))
 *                   (mention (headword company troop unit))))
 *                   </pre>
 *
 * selects mentions that are either of type {@code PER} or whose headword is
...
@Beta
@TextGroupImmutable
public abstract class AllOfPattern implements Pattern {
