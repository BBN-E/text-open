 ...
 */
public final class StripEvents {
  ...
  @Inject
  private StripEvents(SerifXMLLoader loader, SerifXMLWriter writer) {
  ...
  private static void trueMain(String[] argv) throws IOException {
    ...
    Guice.createInjector(ParametersModule.createAndDump(params),
        new SerifEnvironmentM(params)).getInstance(StripEvents.class).go(params);
  }

  private void go(Parameters params) throws IOException {
