        ...
        for i, token in enumerate(sentence.token_sequence):
            ...
            if label.upper() == 'O':  # not a name
                ...
                if bi.upper() == 'B' or \
                        ...
                        (i > 0 and bi.upper() == 'I' and BIO_tags[i - 1].split('-')[
                            1] != type):  # beginning of name span
                    start_idx = i
                ...
                # end of namespan otherwise
                    ...
                    continue
                added_names.extend(self.add_or_update_name(sentence.name_theory, type, sentence.token_sequence[start_idx],
