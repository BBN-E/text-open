...
@TextGroupImmutable
@Value.Immutable
public abstract class ArgumentPatternMatch extends AbstractPatternMatch implements PatternMatch  {
  ...
  public abstract Argument argument();
  ...
  public static ArgumentPatternMatch of(Pattern pattern, DocTheory docTheory,
      SentenceTheory sentenceTheory, Argument argument) {
    return ImmutableArgumentPatternMatch.builder()
        .pattern(pattern)
        .docTheory(docTheory)
