...
def single_document_hanlder(serif_path):
    ...
    for serif_eerm in serif_doc.event_event_relation_mention_set or []:
        ...
        if serif_em_arg1 is not None and serif_em_arg2 is not None:
            ...
            buf = "[EER]\ndocid:{} sentid:{}\nsent:{}\n{}\neer_type:{}\tscore:{}\n{}\n[EER END]".format(serif_doc.docid,sentence.sent_no,sentence_text,left_event_buf,relation_type,confidence,right_event_buf)
            eer_frame.append(buf)
