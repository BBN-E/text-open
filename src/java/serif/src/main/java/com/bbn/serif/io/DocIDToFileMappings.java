 ...
 * @deprecated  delete after 09/30/2016 use {@see {@link com.bbn.nlp.io.DocIDToFileMapping}}
 */
@Deprecated
public final class DocIDToFileMappings {
  ...
  /**
   * Gets a DocIDToFileMapping which does lookup in the provieed map and returns {@link
